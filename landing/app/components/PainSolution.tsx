...
const cards = [
  {
    ...
    solution: 'IA pesquisa e escreve pra voce',
    detail:
  ...
  },
  {
    ...
    solution: 'Imagens e carrosseis gerados em segundos',
    detail:
      'IA gera imagens unicas para cada conteudo. Carrosseis com ate 10 slides prontos.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    pain: 'Sem consistencia',
    solution: 'Agendamento automatico, todo dia tem conteudo',
    detail:
      'Configure uma vez e receba conteudo novo automaticamente, no horario que voce definir.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
