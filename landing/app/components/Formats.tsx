    ...
    <section className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <h2 className="font-display text-3xl sm:text-4xl font-bold text-center mb-4">
          Formatos que a IA cria pra você
        </h2>
        <p className="text-brand-muted text-center mb-16 max-w-md mx-auto">
          Tudo que você precisa pra manter suas redes ativas.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {formats.map((fmt, i) => (
            <div
              key={i}
              className="group flex items-center gap-3 px-6 py-4 rounded-xl border border-brand-border bg-brand-card transition-all duration-300 hover:border-brand-purple/30 hover:bg-brand-card/80"
            >
              <span className="text-brand-purple transition-transform duration-300 group-hover:scale-110">
                {fmt.icon}
              </span>
